...
Citizen.CreateThread(function()
    ...
    local maramap = AddBlipForCoord(1434.80, -1484.74, 63.22)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mara' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mara' then 
...
RMenu.Add('garagemara', 'main', RageUI.CreateMenu("Garage", "Garage mara"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagemara', 'main'), true, true, true, function() 
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mara' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mara' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagemara', 'main'), not RageUI.Visible(RMenu:Get('garagemara', 'main')))
                    end   
                end
            end 
         end
...
RMenu.Add('coffremara', 'main', RageUI.CreateMenu("Coffre", " "))
RMenu.Add('coffremara', 'mettre', RageUI.CreateMenu("Coffre", " "))
RMenu.Add('coffremara', 'enlever', RageUI.CreateMenu("Coffre", " "))

Citizen.CreateThread(function()
    while true do

        RageUI.IsVisible(RMenu:Get('coffremara', 'main'), true, true, true, function()


            RageUI.ButtonWithStyle("Prendre objet", "Pour prendre un objet.", {RightLabel = "→"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                RageUI.CloseAll()
                OpenGetStocksmaraMenu()
                end
                end)
                RageUI.ButtonWithStyle("Déposer objet", "Pour déposer un objet.", {RightLabel = "→"},true, function(Hovered, Active, Selected)
                if (Selected) then   
                RageUI.CloseAll()
                OpenPutStocksmaraMenu()
                end
                end)
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mara' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mara' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffremara', 'main'), not RageUI.Visible(RMenu:Get('coffremara', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStocksmaraMenu()
    ESX.TriggerServerCallback('esx_marajob:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_marajob:prendreitems', itemName, count)
...
function OpenPutStocksmaraMenu()
    ESX.TriggerServerCallback('esx_marajob:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_marajob:stockitem', itemName, count)
...
RMenu.Add('maraf6', 'main', RageUI.CreateMenu("mara", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('maraf6', 'main'), true, true, true, function()
        ...
        RageUI.ButtonWithStyle("Menotter/démenotter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
            if (Selected) then 
                ...
                local target_id = GetPlayerServerId(target)
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_marajob:handcuff', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mara' then  

                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('maraf6', 'main'), not RageUI.Visible(RMenu:Get('maraf6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'mara' then 
