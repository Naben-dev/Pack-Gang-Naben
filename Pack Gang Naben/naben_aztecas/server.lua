...
TriggerEvent('esx_phone:registerNumber', 'aztecas', 'alerte aztecas', true, true)
...
RegisterServerEvent('esx_aztecasjob:prendreitems')
AddEventHandler('esx_aztecasjob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_aztecasjob:stockitem')
AddEventHandler('esx_aztecasjob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_aztecasjob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_aztecasjob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_aztecas', function(inventory)
        cb(inventory.items)
    end)
end)
