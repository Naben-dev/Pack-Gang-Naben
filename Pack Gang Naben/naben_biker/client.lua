...
Citizen.CreateThread(function()
    local bikermap = AddBlipForCoord(983.43, -92.88, 74.85)
    SetBlipSprite(bikermap, 429)
    SetBlipColour(bikermap, 40)
    SetBlipScale(bikermap, 0.8)
    SetBlipAsShortRange(bikermap, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("Quartier Biker")
    EndTextCommandSetBlipName(bikermap)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'biker' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'biker' then 
...
RMenu.Add('garagebiker', 'main', RageUI.CreateMenu("Garage", "Garage biker"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagebiker', 'main'), true, true, true, function() 
            ...
            RageUI.ButtonWithStyle("Avarus", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("Avarus")
        ...
        RageUI.ButtonWithStyle("Cliffhanger", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("cliffhanger")
            end
        end)

        RageUI.ButtonWithStyle("Daemon", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("daemon")
            end
        ...
        RageUI.ButtonWithStyle("Sovereign", nil, {RightLabel = "→"},true, function(Hovered, Active, Selected)
            if (Selected) then
            Citizen.Wait(1)  
            spawnuniCar("sovereign")
            end
        end)
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'biker' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'biker' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagebiker', 'main'), not RageUI.Visible(RMenu:Get('garagebiker', 'main')))
                    end   
                end
               end 
        end
...
RMenu.Add('armubiker', 'main', RageUI.CreateMenu("Armurerie", " "))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('armubiker', 'main'), true, true, true, function()   
            ...
            RageUI.ButtonWithStyle(v.nom, nil, {RightLabel = "~r~$"..v.prix},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('armurerie:biker', v.arme, v.prix)
                end
            end)
        end
...
Citizen.CreateThread(function()
        while true do
		   ...
		   if ESX.PlayerData.job and ESX.PlayerData.job.name == 'biker' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'biker' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('armubiker', 'main'), not RageUI.Visible(RMenu:Get('armubiker', 'main')))
                    end   
                end
            end 
        end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'biker' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'biker' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffrebiker', 'main'), not RageUI.Visible(RMenu:Get('coffrebiker', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStocksbikerMenu()
    ESX.TriggerServerCallback('esx_bikerjob:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_bikerjob:prendreitems', itemName, count)
...
function OpenPutStocksbikerMenu()
    ESX.TriggerServerCallback('esx_bikerjob:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_bikerjob:stockitem', itemName, count)
...
RMenu.Add('bikerf6', 'main', RageUI.CreateMenu("biker", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('bikerf6', 'main'), true, true, true, function()
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'biker' then  
                    ...
                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('bikerf6', 'main'), not RageUI.Visible(RMenu:Get('bikerf6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'biker' then 
