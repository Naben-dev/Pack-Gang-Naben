...
TriggerEvent('esx_phone:registerNumber', 'biker', 'alerte biker', true, true)
...
RegisterServerEvent('esx_bikerjob:prendreitems')
AddEventHandler('esx_bikerjob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_bikerjob:stockitem')
AddEventHandler('esx_bikerjob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_bikerjob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_bikerjob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_biker', function(inventory)
        cb(inventory.items)
    end)
end)
...
RegisterNetEvent('armurerie:biker')
AddEventHandler('armurerie:biker', function(arme, prix)
local _source = source
local xPlayer = ESX.GetPlayerFromId(source)
local price = prix
