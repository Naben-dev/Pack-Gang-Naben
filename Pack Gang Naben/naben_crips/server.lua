...
RegisterServerEvent('esx_cripsjob:prendreitems')
AddEventHandler('esx_cripsjob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_cripsjob:stockitem')
AddEventHandler('esx_cripsjob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_cripsjob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_cripsjob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_crips', function(inventory)
        cb(inventory.items)
    end)
end)
