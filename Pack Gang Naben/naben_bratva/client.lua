...
Citizen.CreateThread(function()
    ...
    local bratvamap = AddBlipForCoord(-2672.17, 1303.45, 147.11)

    SetBlipSprite(bratvamap, 429)
    SetBlipColour(bratvamap, 0)
    SetBlipScale(bratvamap, 0.80)
    SetBlipAsShortRange(bratvamap, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("Maison Bratva")
    EndTextCommandSetBlipName(bratvamap)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bratva' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'bratva' then 
...
RMenu.Add('garagebratva', 'main', RageUI.CreateMenu("Garage", "Garage bratva"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagebratva', 'main'), true, true, true, function() 
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bratva' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'bratva' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagebratva', 'main'), not RageUI.Visible(RMenu:Get('garagebratva', 'main')))
                    end   
                end
               end 
        end
...
function spawnuniCar(car)
    ...
    local plaque = "bratva"..math.random(1,9)
...
RMenu.Add('armubratva', 'main', RageUI.CreateMenu("Armurerie", " "))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('armubratva', 'main'), true, true, true, function()   
            ...
            RageUI.ButtonWithStyle(v.nom, nil, {RightLabel = "~r~$"..v.prix},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('armurerie:bratva', v.arme, v.prix)
                end
            end)
        end
...
Citizen.CreateThread(function()
        while true do
		   ...
		   if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bratva' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'bratva' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('armubratva', 'main'), not RageUI.Visible(RMenu:Get('armubratva', 'main')))
                    end   
                end
            end 
        end
...
RMenu.Add('coffrebratva', 'main', RageUI.CreateMenu("Coffre", " "))

Citizen.CreateThread(function()
    while true do

        RageUI.IsVisible(RMenu:Get('coffrebratva', 'main'), true, true, true, function()
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bratva' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'bratva' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffrebratva', 'main'), not RageUI.Visible(RMenu:Get('coffrebratva', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStocksbratvaMenu()
    ESX.TriggerServerCallback('esx_bratvajob:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_bratvajob:prendreitems', itemName, count)
...
function OpenPutStocksbratvaMenu()
    ESX.TriggerServerCallback('esx_bratvajob:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_bratvajob:stockitem', itemName, count)
...
RMenu.Add('bratvaf6', 'main', RageUI.CreateMenu("bratva", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('bratvaf6', 'main'), true, true, true, function()
        ...
        RageUI.ButtonWithStyle("Menotter/démenotter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
            if (Selected) then
                ...
                local target_id = GetPlayerServerId(target)
                if closestPlayer ~= -1 and closestDistance <= 3.0 then 
                TriggerServerEvent('esx_bratvajob:handcuff', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Escorter", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_bratvajob:drag', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
            ...
            RageUI.ButtonWithStyle("Mettre dans un véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_bratvajob:putInVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
                end
            ...
            RageUI.ButtonWithStyle("Sortir du véhicule", nil, {RightLabel = "→"}, true, function(Hovered, Active, Selected)
                if (Selected) then
					...
					local target_id = GetPlayerServerId(target)
					if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('esx_bratvajob:OutVehicle', GetPlayerServerId(closestPlayer))
            else
                ESX.ShowNotification('Peronne autour')
            end
            end
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bratva' then  

                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('bratvaf6', 'main'), not RageUI.Visible(RMenu:Get('bratvaf6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'bratva' then 
	...
	ESX.TriggerServerCallback('esx_bratvajob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search', {
			...
			if data.current.value then
				TriggerServerEvent('esx_bratvajob:confiscatePlayerItem', GetPlayerServerId(player), data.current.itemType, data.current.value, data.current.amount)
