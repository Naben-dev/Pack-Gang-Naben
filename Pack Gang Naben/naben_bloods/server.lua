...
RegisterServerEvent('esx_bloodsjob:prendreitems')
AddEventHandler('esx_bloodsjob:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_bloodsjob:stockitem')
AddEventHandler('esx_bloodsjob:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_bloodsjob:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_bloodsjob:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_bloods', function(inventory)
        cb(inventory.items)
    end)
end)
