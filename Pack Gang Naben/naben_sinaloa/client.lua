...
Citizen.CreateThread(function()
    ...
    local sinaloamap = AddBlipForCoord(-1805.20, 437.31, 128.70)

    SetBlipSprite(sinaloamap, 429)
    SetBlipColour(sinaloamap, 0)
    SetBlipScale(sinaloamap, 0.80)
    SetBlipAsShortRange(sinaloamap, true)
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("Maison Sinaloa")
    EndTextCommandSetBlipName(sinaloamap)
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in pairs(Config.pos) do
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'sinaloa' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'sinaloa' then 
...
RMenu.Add('garagesinaloa', 'main', RageUI.CreateMenu("Garage", "Garage sinaloa"))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('garagesinaloa', 'main'), true, true, true, function() 
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'sinaloa' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'sinaloa' then    
                    ...
                    if IsControlJustPressed(1,51) then           
                        RageUI.Visible(RMenu:Get('garagesinaloa', 'main'), not RageUI.Visible(RMenu:Get('garagesinaloa', 'main')))
                    end   
                end
               end 
        end
...
function spawnuniCar(car)
    ...
    local plaque = "sinaloa"..math.random(1,9)
...
RMenu.Add('armusinaloa', 'main', RageUI.CreateMenu("Armurerie", " "))

Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('armusinaloa', 'main'), true, true, true, function()   
            ...
            RageUI.ButtonWithStyle(v.nom, nil, {RightLabel = "~r~$"..v.prix},true, function(Hovered, Active, Selected)
                if (Selected) then   
                    TriggerServerEvent('armurerie:sinaloa', v.arme, v.prix)
                end
            end)
        end
...
Citizen.CreateThread(function()
        while true do
		   ...
		   if ESX.PlayerData.job and ESX.PlayerData.job.name == 'sinaloa' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'sinaloa' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('armusinaloa', 'main'), not RageUI.Visible(RMenu:Get('armusinaloa', 'main')))
                    end   
                end
            end 
        end
...
RMenu.Add('coffresinaloa', 'main', RageUI.CreateMenu("Coffre", " "))

Citizen.CreateThread(function()
    while true do

        RageUI.IsVisible(RMenu:Get('coffresinaloa', 'main'), true, true, true, function()
...
Citizen.CreateThread(function()
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'sinaloa' or ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'sinaloa' then  
                    ...
                    if IsControlJustPressed(1,51) then
                        RageUI.Visible(RMenu:Get('coffresinaloa', 'main'), not RageUI.Visible(RMenu:Get('coffresinaloa', 'main')))
                    end   
                end
               end 
        end
...
function OpenGetStockssinaloaMenu()
    ESX.TriggerServerCallback('esx_sinaloajob:prendreitem', function(items)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_sinaloajob:prendreitems', itemName, count)
...
function OpenPutStockssinaloaMenu()
    ESX.TriggerServerCallback('esx_sinaloajob:inventairejoueur', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                ...
                if not count then
                    ...
                    menu2.close()
                    menu.close()
                    TriggerServerEvent('esx_sinaloajob:stockitem', itemName, count)
...
RMenu.Add('sinaloaf6', 'main', RageUI.CreateMenu("sinaloa", "Intéraction"))
...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('sinaloaf6', 'main'), true, true, true, function()
        ...
        while true do
            ...
            if ESX.PlayerData.job and ESX.PlayerData.job.name == 'sinaloa' then  
                    ...
                    if IsControlJustPressed(0, 167) then
                        RageUI.Visible(RMenu:Get('sinaloaf6', 'main'), not RageUI.Visible(RMenu:Get('sinaloaf6', 'main')))
                end   
        end 
    end
end)
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
            ...
            if ESX.PlayerData.job2 and ESX.PlayerData.job2.name == 'sinaloa' then 
