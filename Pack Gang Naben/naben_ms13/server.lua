...
TriggerEvent('esx_phone:registerNumber', 'ms13', 'alerte ms13', true, true)
...
RegisterServerEvent('esx_ms13job:prendreitems')
AddEventHandler('esx_ms13job:prendreitems', function(itemName, count)
...
RegisterNetEvent('esx_ms13job:stockitem')
AddEventHandler('esx_ms13job:stockitem', function(itemName, count)
    local _source = source
...
ESX.RegisterServerCallback('esx_ms13job:inventairejoueur', function(source, cb)
    local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_ms13job:prendreitem', function(source, cb)
    TriggerEvent('esx_addoninventory:getSharedInventory', 'society_ms13', function(inventory)
        cb(inventory.items)
    end)
end)
...
ESX.RegisterServerCallback('esx_ms13job:addArmoryWeapon', function(source, cb, weaponName, removeWeapon)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('esx_ms13job:confiscatePlayerItem')
...
ESX.RegisterServerCallback('esx_ms13job:getOtherPlayerData', function(source, cb, target, notify)
